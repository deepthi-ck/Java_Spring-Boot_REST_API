...
Monolithic Spring Boot REST application (Scenario 1), Java 11 only.

Stack: Spring Boot **2.7.x** on the `javax.*` namespace (Java 11 compatible; not Spring Boot 3 / Jakarta).
