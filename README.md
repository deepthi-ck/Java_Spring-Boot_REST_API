# Java Spring Boot REST API — Java 11

Single-module Spring Boot REST API (`java.version=11`).  
Tools are wired into this project (Maven + `config/` + `scripts/`) — **not** separate tool folders.

Tool versions follow [Golden_Repo_Lite Java-11](https://github.com/testable-platform/Golden_Repo_Lite/tree/java/Java-11).
