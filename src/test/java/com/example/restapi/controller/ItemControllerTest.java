...
class ItemControllerTest {
    ...
    void listOk() throws Exception {
        ...
        item.setId(1L); item.setName("Book"); item.setSku("BOOK-1"); item.setPrice(10.0); item.setStock(2);
    ...
    void createCreated() throws Exception {
        ...
        req.setName("Pen"); req.setSku("PEN-1"); req.setPrice(2.0); req.setStock(5);
        ItemResponse resp = new ItemResponse();
        resp.setId(1L); resp.setName("Pen"); resp.setSku("PEN-1");
