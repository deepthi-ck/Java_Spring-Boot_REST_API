...
public class CustomerMapper {
    public Customer toEntity(Long id, CustomerRequest request) {
        Address address = new Address(request.getLine1(), request.getCity(), request.getState(),
    ...
    public void updateEntity(Customer customer, CustomerRequest request) {
        ...
        customer.setAddress(new Address(request.getLine1(), request.getCity(), request.getState(),
                request.getPostalCode(), request.getCountry()));
    }
}
